          ...
          {projectCategories.map((cat) => (
            <button
              ...
              className={cn(
                ...
                activeFilter === cat.id
                  ? 'bg-gradient-to-r from-brand-500 to-accent-purple text-white shadow-brand'
                  : 'bg-surface-1 text-gray-600 border border-gray-100 hover:border-brand-200 hover:text-brand-600'
              )}
            >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4 py-4 border-t border-gray-50">
                      {project.results.slice(0, 2).map((r) => (
                        <div key={r.label}>
                          <p className="text-lg font-display font-bold text-brand-600">{r.value}</p>
                    ...
                    <div className={`flex items-center gap-1.5 text-sm font-medium text-brand-600 mt-4 group-hover:gap-2.5 transition-all duration-200`}>
